...
console.log("📦 Installing dependencies (Tailwind, Shadcn, Radix)...");
run(`npm install tailwindcss postcss autoprefixer @radix-ui/react-navigation-menu @radix-ui/react-accordion`);
run(`npm install class-variance-authority clsx tailwind-variants lucide-react`);
...
run(`npx shadcn-ui add navigation-menu`);
run(`npx shadcn-ui add card`);
run(`npx shadcn-ui add accordion`);
run(`npx shadcn-ui add button`);

// 5. Create src/components
  ...
  return (
    <section className="bg-gray-100 py-20 text-center">
      ...
      <p className="text-lg text-gray-600 mb-6">
        This is a beautiful hero section built with Tailwind + Shadcn.
      </p>
